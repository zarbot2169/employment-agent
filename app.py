...
genai.configure(api_key="AIzaSyA2atuzXvtOJCssi0qN0iEVmrq0gHSj_f8")
model = genai.GenerativeModel('gemini-1.5-flash')

# ذخیره داده‌ها موقت (session state)
...
def send_verification_email(email, code):
    sender = "zarbot2169@gmail.com"
    password = "lbcg vegx ddjy awyx"  # app password
...
if st.session_state.current_user is None:
    ...
    # دکمه خروج (خارج از بلوک if user_input)
    if st.button("خروج"):
        st.session_state.current_user = None
